...
# Add this function to mark steps for CUDA graphs
def mark_step_before_generate(model):
    torch.compiler.cudagraph_mark_step_begin()
    return model

# Wrap the original generate method
original_generate = PreTrainedModel.generate
def generate_with_step_marker(self, *args, **kwargs):
    mark_step_before_generate(self)
    return original_generate(self, *args, **kwargs)

# Apply the patched method
PreTrainedModel.generate = generate_with_step_marker
...
average_inference_time = total_time / len(df)
