...
# def create_transformers_qa_system(model_name="/scratch/gjf3sa/llama8b_lora_accerate_entireModel_3", temperature=0.7):
#     """
...
print(model.config.max_position_embeddings)   # → 8192
