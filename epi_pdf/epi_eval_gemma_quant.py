...
model = Gemma3ForConditionalGeneration.from_pretrained(
    model_id, device_map="auto", torch_dtype=torch.bfloat16,quantization_config=bnb_config4,
).eval()
...
df.to_csv("/home/gjf3sa/sneha/midas/qwen/epi_pdf/gemma_logs/pdf_epi_final_gemma12B_2shot_quant4.csv", index=False)
