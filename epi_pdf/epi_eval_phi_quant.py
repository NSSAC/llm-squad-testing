...
for i in range(0,num_examples):
    ...
    row_result =  squad_metric.compute(predictions=[pred], references=[ref], no_answer_threshold=1)
...
df.to_csv("/home/gjf3sa/sneha/midas/qwen/epi_final/phi_logs/pdf_epi_final_phi_2shot_quant8.csv", index=False)
