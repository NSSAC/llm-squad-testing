...
system_message=f"""You are a precise and reliable assistant trained to answer questions 
in a single word or single phrase strictly based on 
the given background. Use the provided background to answer questions. 
When answering, you must **locate** the answer span in the provided context
...
df.to_csv("/home/gjf3sa/sneha/midas/qwen/epi_pdf/check_pdf_sep25_final_llama1B_quant4.csv", index=False)
